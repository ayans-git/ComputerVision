...
image_file = 'Image.002.jpg'

image, image_w, image_h = load_image_pixels(image_file, (input_w, input_h))
...
#Download pretrained weights from: https://pjreddie.com/media/files/yolov3.weights
